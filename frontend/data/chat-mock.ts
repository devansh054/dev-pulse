...
const users: Record<string, ChatUser> = {
  ...
  rampant: {
    ...
    avatar: "/avatars/user_rampant.png",
    isOnline: false,
  },
};
...
// Function to add team member to chat
export const addTeamMemberToChat = (member: {
  id: number;
  name: string;
  ...
  // Add to users object
  users[member.githubUsername] = newUser;
  ...
  const newConversation: ChatConversation = {
    ...
    lastMessage: {
      ...
      content: `HEY ${currentUser.name}! THANKS FOR ADDING ME TO THE TEAM!`,
  ...
  conversations.unshift(newConversation); // Add to beginning for visibility
